...
$(EXEC): $(OBJ_DIR)$(EXEC).o $(OBJ_DIR)liaison.o $(OBJ_DIR)analyseur.o $(OBJ_DIR)network.o $(OBJ_DIR)ip.o $(OBJ_DIR)icmp.o $(OBJ_DIR)arp.o $(OBJ_DIR)transport.o $(OBJ_DIR)ospf_v2.o $(OBJ_DIR)application.o $(OBJ_DIR)dns.o $(OBJ_DIR)transfer.o $(OBJ_DIR)dhcp.o $(OBJ_DIR)telnet.o
...
$(OBJ_DIR)icmp.o: $(SRC_DIR)icmp.c $(HD_DIR)icmp.h
	$(CC) -c $< $(CFLAGS)
	mkdir -p $(OBJ_DIR)
	mv icmp.o $(OBJ_DIR)
...
$(OBJ_DIR)transport.o: $(SRC_DIR)transport.c $(HD_DIR)transport.h $(HD_DIR)ospf_v2.h
	$(CC) -c $< $(CFLAGS)
	mkdir -p $(OBJ_DIR)
	mv transport.o $(OBJ_DIR)

$(OBJ_DIR)ospf_v2.o: $(SRC_DIR)ospf_v2.c $(HD_DIR)ospf_v2.h
	$(CC) -c $< $(CFLAGS)
	mkdir -p $(OBJ_DIR)
	mv ospf_v2.o $(OBJ_DIR)
