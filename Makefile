...
$(EXEC): $(OBJ_DIR)$(EXEC).o $(OBJ_DIR)liaison.o $(OBJ_DIR)analyseur.o $(OBJ_DIR)network.o $(OBJ_DIR)ip.o $(OBJ_DIR)arp.o $(OBJ_DIR)transport.o $(OBJ_DIR)application.o $(OBJ_DIR)dns.o $(OBJ_DIR)transfer.o $(OBJ_DIR)dhcp.o
...
$(OBJ_DIR)application.o: $(SRC_DIR)application.c $(HD_DIR)application.h $(HD_DIR)dns.h $(HD_DIR)transfer.h $(HD_DIR)dhcp.h
	$(CC) -c $< $(CFLAGS)
	mkdir -p $(OBJ_DIR)
